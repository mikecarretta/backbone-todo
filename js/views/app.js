var app = app || {};
  ...
  app.AppView = Backbone.View.extend({
    ...
    initialize: function() {
      // using jQuery to cache the elements it will be using into local properties
      this.allCheckbox = this.$('#toggle-all')[0];
      this.$input = this.$('#new-todo');
      this.$navstats = this.$('#navstats');
      this.$main = this.$('#main');

      // binding to two events on the Todos collection
    ...
    render: function() {
      ...
      if ( app.Todos.length ) {
        ...
        this.$navstats.html(this.statsTemplate({
          completed: completed,
          remaining: remaining
        }));
